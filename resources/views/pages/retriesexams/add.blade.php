            ...
            <div class="col-lg-8 offset-lg-2 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('retriesexams.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                <label>Fan</label><br />
                                <select class="form-control select2" name="subjects_id" id="subject_id" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="select2-purple">
                                    <select class="select2 exam_topics" name="topics_id[]" multiple="multiple" data-placeholder="mavzularni tanlang" data-dropdown-css-class="select2-purple" style="width: 100%;" id="exam_topics" required>
                                        <option>-----</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="datetime-local" name="start" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="datetime-local" name="end" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ route('retriesexams.index') }}" class="btn btn-default float-left">Bekor qilish</a>
                            </div>
                        </form>
