            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('groupIndex') }}">Guruhlar</a></li>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('groupCreate') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="group" class="form-control {{ $errors->has('name') ? "is-invalid":"" }}" value="{{ old('group') }}" required>
                                @if($errors->has('name'))
