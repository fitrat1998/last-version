            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('finalexams.index') }}">Yakuniy nazorat</a>
                        </li>
            ...
            <div class="col-lg-8 offset-lg-2 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('finalexams.update',$finalexam->id) }}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="examtypes_id" id="examtypes_id">
                                    ...
                                    @foreach($examtypes as $examtype)
                                        ...
                                        " {{ ($examtype->id == $finalexam->examtypes_id ? "selected":'') }}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="number"
                                       ...
                                       value="{{ old('selfstudy',$finalexam->number) }}" required>
                                @if($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="groups_id" id="group_id">
                                    ...
                                    @foreach($groups as $group)
                                        <option
                                                value="{{ $group->id }}" {{ ($group->id == $finalexam->groups_id ? "selected":'') }}>{{ $group->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="subjects_id" id="subject_id" onchange="">
                                    ...
                                    @foreach($subjects as $subject)
                                        <option
                                                value="{{ $subject->id }}" {{ ($subject->id == $finalexam->subjects_id ? "selected":'') }}>{{ $subject->subject_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="semesters_id" id="semester_id">
                                    ...
                                    @foreach($semesters as $semester)
                                        <option
                                                value="{{ $semester->id }}" {{ ($semester->id == $finalexam->semesters_id ? "selected":'') }}>{{ $semester->semester_number }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="datetime-local" name="start" class="form-control"
                                           ...
                                           data-mask value="{{ old('date',$finalexam->start) }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="attempts"
                                       class="form-control {{ $errors->has('name') ? "is-invalid":"" }}"
                                       value="{{ old('attempts',$finalexam->attempts) }}" required>
                                @if($errors->has('name'))
                                    <span class="error invalid-feedback">{{ $errors->first('name') }}</span>
                                @endif
                            </div>
                             ...
                             <div class="form-group">
                                ...
                                <input type="number" name="passing"
                                       ...
                                       value="{{ old('finalexams',$finalexam->passing) }}" required>
                                @if($errors->has('name'))
                                    <span class="error invalid-feedback">{{ $errors->first('name') }}</span>
                                @endif
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ route('finalexams.index') }}" class="btn btn-default float-left">Bekor
                                    qilish</a>
                            </div>
                        </form>
