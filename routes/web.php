...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::delete('/group/deleteAll', [GroupController::class, 'deleteAll'])->name('groupDeleteAll');
    ...
    Route::delete('/faculty/deleteAll', [FacultyController::class, 'deleteAll'])->name('facultyDeleteAll');
    ...
    Route::delete('/formofeducation/deleteAll', [FormofeducationController::class, 'deleteAll'])->name('formofeducationDeleteAll');
    ...
    Route::delete('/educationyear/deleteAll', [EducationyearController::class, 'deleteAll'])->name('educationyearDeleteAll');
    ...
    Route::delete('/educationtype/deleteAll', [EducationtypeController::class, 'deleteAll'])->name('educationtypeDeleteAll');
    ...
    Route::delete('/semester/deleteAll', [SemesterController::class, 'deleteAll'])->name('semesterDeleteAll');
    ...
    Route::delete('/subject/deleteAll', [SubjectController::class, 'deleteAll'])->name('subjectDeleteAll');
    ...
    Route::delete('/deleteAllQuestion', 'QuestionsController@deleteAll')->name('questions.DeleteAll');
    ...
    Route::delete('/deleteAllLessontype', 'LessontypeController@deleteAll')->name('lessontypes.DeleteAll');

    //Teachers
    Route::resource('teachers', 'TeacherController');
    Route::delete('/deleteAllTeacher', 'TeacherController@deleteAll')->name('teachers.DeleteAll');
    ...
    Route::delete('/deleteAllAttendanceCheck', 'AttendanceCheckController@deleteAll')->name('attendancechecks.DeleteAll');

    //Exercises
    Route::resource('exercises', 'ExerciseController');
    Route::delete('/deleteAllExercise', 'ExerciseController@deleteAll')->name('exercises.DeleteAll');

    //MiddleExam
    Route::resource('middleexams', 'MiddleexamController');
    Route::delete('/deleteAllMiddleexam', 'MiddleexamController@deleteAll')->name('middleexams.DeleteAll');

    //SelfstudyExam
    Route::resource('selfstudyexams', 'SelfstudyexamsController');
    Route::delete('/deleteAllSelfstudyexams', 'SelfstudyexamsController@deleteAll')->name('selfstudyexams.DeleteAll');

    //RetryExam
    Route::resource('retriesexams', 'RetriesexamController');
    Route::delete('/deleteAllRetriesexam', 'RetriesexamController@deleteAll')->name('retriesexams.DeleteAll');


    Route::resource('finalexams', 'FinalexamController');
    Route::delete('/deleteAllFinalexam', 'FinalexamController@deleteAll')->name('finalexams.DeleteAll');


    Route::resource('currentexams', 'CurrentexamController');
    Route::delete('/deleteAllCurrentexam', 'CurrentexamController@deleteAll')->name('currentexams.DeleteAll');


    Route::resource('announcements', 'AnnouncementController');
    Route::delete('/deleteAllAnnouncement', 'AnnouncementController@deleteAll')->name('announcements.DeleteAll');
